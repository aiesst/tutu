...
declare module BootstrapFileInput {
  interface FileInputOptions {
    ...
    /**
     the extra data that will be passed as data to the initial preview delete callbackUrl/AJAX server call via POST.
     This will be overridden by the initialPreviewConfig['extra'] property.
     This property is only applicable for ajax deletions in initial preview and when you have set a value for initialPreviewConfig['callbackUrl'] or deleteUrl.
    ...
    deleteExtraData?: {} | { (): {} };
    /**
     the URL for deleting the image/content in the initial preview via AJAX post response. This will be overridden by the initialPreviewConfig['callbackUrl'] property.
     Note
     The ajax delete action will send the following data to server via POST:
     key: the key setting as setup in initialPreviewConfig['key']
     any other extra data passed as key: value pairs either via initialPreviewConfig['extra'] OR deleteExtraData if former is not set.
    ...
    uploadAsync?: boolean;
    /**
     the extra data that will be passed as data to the callbackUrl/AJAX server call via POST.
  ...
  interface PreviewConfig {
    ...
    url: string;
    /**
     the key that will be passed as data to the callbackUrl via AJAX POST.
     */
    key: string | {};
    /**
    ...
    frameAttr: {};
    /**
     the extra data that will be passed as data to the initial preview delete callbackUrl / AJAX server call via POST.This will default to deleteExtraData if not set.
     */
    extra: {} | Function;
  }
  ...
  interface LayoutTemplates {
    ...
    /**
     ...
     {dataUrl}: the URL for deleting the file thumbnail for initialPreview content only. Will be replaced with the callbackUrl set within initialPreviewConfig.
